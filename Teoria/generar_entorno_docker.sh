...
# Creación de la red y máquinas para el entorno
...
docker run --detach --privileged --volume=/sys/fs/cgroup:/sys/fs/cgroup:rw --ip 172.18.0.4 --cgroupns=host --name=ubuntu1 --network=ansible apasoft/ubuntu22-ansible 
